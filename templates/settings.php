			...
			<tr>
				...
				<td>
					<select name="default_status" id="default_status">
						<?php
						foreach ( array(
							'draft'   => __( 'Brouillon', 'ai-product-studio' ),
							'publish' => __( 'Publié', 'ai-product-studio' ),
							'pending' => __( 'En attente', 'ai-product-studio' ),
						) as $val => $label ) :
							?>
					...
					<label><?php esc_html_e( 'Plugin SEO', 'ai-product-studio' ); ?>
						<select name="seo_plugin">
							...
							foreach ( array(
								...
								'yoast'    => 'Yoast SEO',
								'rankmath' => 'Rank Math',
								'none'     => __( 'Aucun', 'ai-product-studio' ),
							) as $val => $label ) :
								?>
				...
				<td>
					<label><?php esc_html_e( 'Niveau', 'ai-product-studio' ); ?>
						<select name="log_level">
							<?php foreach ( array( 'debug', 'info', 'notice', 'warning', 'error' ) as $level ) : ?>
